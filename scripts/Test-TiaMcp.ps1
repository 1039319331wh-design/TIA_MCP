...
foreach ($requiredTool in 'tia_list_tag_tables', 'tia_export_tag_table', 'tia_search_tag_table', 'tia_get_plc_overview', 'tia_get_tag_table_overview', 'tia_get_block_interface', 'tia_search_plc_blocks', 'tia_get_block_dependencies', 'tia_get_hardware_overview', 'tia_create_project_snapshot', 'tia_compare_project_snapshot') {
